    ...
    <div class="container mx-auto px-4">
        ...
        <div v-if="selectedTab === 'todos'">
            <div v-for="restaurante in restaurantes" :key="restaurante.id"
                ...
                <button v-if="!restaurante.favorito"
                    class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2"
                    @click="adicionarFavorito(restaurante.id)">
                    Adicionar aos Favoritos
                </button>
                <button v-else class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ml-2"
        ...
        <div v-if="selectedTab === 'favoritos'">
            <div v-for="restaurante in restaurantesFavoritos" :key="restaurante.id"
                class="bg-white rounded-lg shadow-md p-4 mb-4">
                <h2 class="text-xl font-bold mb-2">{{ restaurante.nome }}</h2>
                <p>{{ restaurante.endereco }}</p>
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
